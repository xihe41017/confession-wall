...
def install_nginx(_: User = Depends(require_super_admin)):
...
def add_domain(payload: NginxDomainIn, _: User = Depends(require_super_admin)):
...
def remove_domain(domain: str, _: User = Depends(require_super_admin)):
